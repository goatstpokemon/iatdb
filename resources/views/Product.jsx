...
const Product = () => {
    ...
    const product = {
        ...
        image: "storage/person.jpg",
        price: 0.2,
        description:
            "Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel impedit inventore, earum nostrum porro dolorem asperiores? Est, quasi. Saepe laborum sequi iste repellat consequatur dolorem impedit, non aspernatur temporibus est!",
        category: "Category 1",
        reviews: [
                ...
                <div className="max-w-[32rem]">
                    <nav>
                        <Breadcrumb>
                            <BreadcrumbList>
                                ...
                                <BreadcrumbItem>
                                    <BreadcrumbLink href="/schrijfgerij">
                                        Schrijfgerij
                                    </BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator>
                    ...
                    <section className="mt-4 w-full">
                        ...
                        <div className="flex flex-col items-center max-w-fit">
                            ...
                            <Link to={"/garantie"} className="mt-4 flex gap-2">
